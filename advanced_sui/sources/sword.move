...
public fun attack(self: &mut Sword) {
...
public fun new_sword(forge: &mut Forge, magic: u64, strength: u64, clock: &Clock, ctx: &mut TxContext): Sword {
...
fun test_sword_create() {
    ...
    let mut sword = Sword {
        ...
        magic: 42,
        strength: 7,
        attributes: bag::new(&mut ctx)
    };

    sword.attributes.add(b"strength".to_string(), 7); // string -> u64
    sword.attributes.add(b"magic".to_string(), 42); // string -> u64
    sword.attributes.add(7, b"strength".to_string()); // u64 -> string
